...
/**
 * This class is used to display shimmer placeholder layouts in different views
 *
 * This class was not created by me.
 * I have been using this in my other projects as well.
 * I am unaware of the exact source of this class.
 */
    ...
    private static class Mask {
        ...
        public int[] getGradientColors() {
            switch (shape) {
                default:
                case LINEAR:
                    return new int[]{Color.TRANSPARENT, Color.parseColor("#80000000"), Color.parseColor("#80000000"), Color.TRANSPARENT};
                case RADIAL:
